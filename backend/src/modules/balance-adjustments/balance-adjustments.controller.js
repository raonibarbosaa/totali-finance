...
exports.previa   = async (req, res) => { try { ok(res, await svc.previa(req.tenantId, req.query.bankAccountId, req.query.data, req.query.ignorarAjusteId));  } catch(e){err(res,e);} };
...
exports.atualizar= async (req, res) => { try { ok(res, await svc.atualizar(req.params.id, req.tenantId, req.user.id, req.body));   } catch(e){err(res,e);} };
exports.cancelar = async (req, res) => { try { ok(res, await svc.cancelar(req.params.id, req.tenantId, req.user.id, req.body));    } catch(e){err(res,e);} };
